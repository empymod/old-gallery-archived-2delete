r"""
Calculating the fields from a magnetic source using duality
===========================================================

Calculating the :math:`E` and :math:`H` fields from a magnetic source using the
duality principle.

We know that we can get the magnetic fields from the electric fields using
Faraday's law, see the example `magnetic field
<https://empymod.github.io/emg3d-gallery/gallery/magnetics/magnetic_field.html>`_.

However, what about calculating the fields generated by a magnetic source?
...
This is what we do in this notebook, for an arbitrarily rotated loop in a
